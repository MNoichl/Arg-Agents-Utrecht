---
pagetitle: "Agentic LLMs for Argument Mining in Philosophical Texts - Utrecht"
bibliography:
...
* Research question, motivation and method
* Argumentation in philosophy
* Choosing argumentation frameworks
* Results (Max takes over, with his own slides?)
...
* Method:
    ...
    - The use of agentive LLMs to break down the analysis in controllable steps
...
* A metric for further quantitative and qualitative exploration of the body of knowledge that forms philosophy
...
* 21 articles, median length 32 pages (range 16–42).
* Chosen for the quality of the texts, our familiarity with them, and their interest to our audience.
* Excluded: Turing's *Computing Machinery and Intelligence* — the *imitation game* setup kept triggering our AI provider's safety features.
...
* Agentic loop instead of single-pass prompting: arguments are distributed across philosophical texts in a highly nonlinear fashion.
* GPT-5.4 (reasoning effort "medium") in OpenAI's Codex CLI — tool-use, repeated text-lookups, iterative building of structures.
* Pass 1: work through the whole text (Markdown), annotate argumentatively relevant passages.
* Pass 2: build a JSON argument graph, following scheme-specific guidelines — generic, Dung-style, Carneades-style.
...
# Pilot study: Results {layout="bullets" .gp-dense data-gp-section="Results"}

* Holistic check of papers we know well: reconstruction of argumentative lines impressively good.
* Human validation: 46 of 50 uniformly sampled links fully justified (92%, 95% Wilson CI [81.2%, 96.8%]).
...
* But: Carneades is hard to follow — significantly more guideline deviations.
